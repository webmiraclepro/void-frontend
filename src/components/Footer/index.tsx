          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
              <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
                <a className="inline-block mb-10 text-white text-3xl font-bold leading-none" rel="noreferrer" href="#">
                  <img
                    className="h-24"
                ...
                <div>
                  <a className="inline-block w-10 mr-3 p-2 bg-gray-800 hover:bg-gray-700 rounded" rel="noreferrer" href="https://twitter.com/DeFIRE_ORG" target="_blank">
                    <img
                      className="w-8 h-6"
                      src="/svg/twitter.svg"
                      alt=""
                  ...
                  <a className="inline-block w-10 p-2 mr-3 bg-gray-800 hover:bg-gray-700 rounded" href="https://discord.gg/defire" rel="noreferrer" target="_blank">
                    <img
                      className="w-8 h-6"
                      src="/svg/discord.svg"
                      alt=""
                  ...
                  <a className="inline-block w-10 mr-3 p-2  bg-gray-800  hover:bg-gray-700 rounded" href="https://medium.com/@defire.org" rel="noreferrer" target="_blank">
                    <img
                      className="w-8 h-6"
