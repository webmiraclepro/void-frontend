const Nft = () => {
  return (
    <div className="items-start flex flex-col mt-8 2xl:w-[338px] xl:w-[260px]">
      <div className="ml-6 mt-1 min-h-[35px] text-x04051a font-poppins text-xxxl font-semibold">NFT</div>
      <div className="rounded-lg h-[201px] mt-2.5 w-full">
        <div className="bg-[url('/img/rectangle-687@1x.png')] items-end bg-center bg-cover rounded-lg flex h-full min-w-full ml-0 mt-0">
          <div className="flex flex-col w-full mt-4 bg-[url('/img/blur-rectangle-1@1x.png')] bg-cover h-[83px]">
            <div className="-ml-64 mt-5 text-center font-medium text-wild-sand text-fsm font-avenirnext-medium">MINT</div>
