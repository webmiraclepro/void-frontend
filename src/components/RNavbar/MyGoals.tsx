...
const MyGoals = () => {
  return (
    <div>
      <div className="flex flex-col -ml-20 w-full h-[294px]">
        <div className="flex flex-col bg-white rounded-lg h-[130px] w-[338px] ml-20 shadow-[10px_24px_54px_#0000000f]">
          <div className="flex flex-row items-center -mt-12">
            <div className="ml-2.5 font-poppins font-semibold text-x04051a text-xxxl">{data.mygoals}</div>
            <div className="flex flex-1 w-full ml-40">
              <div className="flex flex-col flex-1 items-start ml-0.5 mr-1 mt-1">
                <div className="relative -ml-0 -mt-px w-[16px] h-[4px]">
          ...
          <div className="flex flex-row justify-center space-x-10 items-center mt-8 -ml-5">
            <div className="relative w-[92px] h-[92px]">
              ...
              <div className="absolute left-[25px] top-[36px] text-center  font-arial-regular text-green-blue text-xl font-normal ">{data.vacationPro}</div>
            </div>
            <div className=" font-avenirnext-medium text-x04051a text-xxxl font-bold">{data.vacation}</div>
            <ArrowGoal />
          </div>
        </div>
        <div className="-mt-8 bg-[url('/img/pfad-6@1x.png')] bg-cover h-[263px] 2xl:w-[488px] xl:w-[300px]">
          <div className="flex flex-row justify-center space-x-10 items-center mt-16 -ml-8 ">
            <div className="relative w-[92px] h-[92px]">
            ...
            <div className="font-avenirnext-medium text-x04051a text-xxxl font-bold">{data.lambo}</div>
            <ArrowGoal />
          </div>
        </div>
      </div>
