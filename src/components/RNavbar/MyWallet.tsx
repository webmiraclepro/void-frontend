      ...
      <div className="flex mt-2.5 rounded-lg w-full h-[201px]">
        <div className="flex flex-col ml-0 mt-0 w-full h-full rounded-lg" style={{ background: 'linear-gradient(139.94deg, #000c65 0%, #a9bac6 70.71%)' }}>
          ...
          <div className="flex flex-col flex-1 w-full mt-4 bg-[url('/img/blur-rectangle-1@1x.png')] bg-cover h-[83px] ">
            <div className="mt-5 pl-6 font-medium text-wild-sand 2xl:text-fsm text-xs font-avenirnext-medium">Balance in Void Token</div>
            <div className='flex flex-row justify-between items-center mt-2.5'>
              <div className="ml-5 font-bold 2xl:text-xxl text-xl text-white font-avenirnext-bold">{formatToCurrency(Number(Props.balance))}</div>
              <div className="mr-1 text-center 2xl:text-fsl text-xs font-medium font-avenirnext-medium text-wild-sand">BALANCE</div>
            </div>
          </div>
        </div>
      </div>
