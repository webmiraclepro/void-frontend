      ...
      <div className="flex mt-2.5 rounded-lg w-full h-[201px]">
        <div className="flex flex-col ml-0 mt-0 w-full h-full rounded-lg" style={{ background: 'linear-gradient(139.94deg, #000c65 0%, #a9bac6 70.71%)' }}>
          <div className='flex flex-col w-full'>
            ...
            <div className="flex flex-row justify-around space-x-8 items-center mt-3 mb-1.5 text-wild-sand font-nunito_sans text-xl font-normal">
              <div className="">****</div>
              <div className="">****</div>
              <div className="">****</div>
          ...
          <div className="flex flex-col flex-1 w-full mt-4 bg-[url('/img/blur-rectangle-1@1x.png')] bg-cover h-[83px]">
            <div className="-ml-40 mt-5 text-center font-medium text-wild-sand text-fsm font-avenirnext-medium">Balance in Void Token</div>
