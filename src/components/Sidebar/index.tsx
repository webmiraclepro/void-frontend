            ...
            <div className="flex items-end justify-center h-full">
                <div className="bg-x04051a h-[1476px] -mb-16 pr-12 border border-violet-blue">
                    <div className="flex flex-col 2xl:ml-16 xl:ml-8 mt-40 items-center h-full">
                        <img className="h-[102px] w-[212px] object-cover" src="/img/voidcard-logo@1x.png" alt="" />
                        <div className="flex flex-row justify-start items-center w-full space-x-10 mt-28">
                            ...
                            <div className="tracking-[0.12px] text-blueberry font-avenirnext-medium text-xxxl font-medium">{data.dashboard}</div>
                        </div>
                        <div className="flex flex-row justify-start items-center w-full space-x-10 mt-14">
                            ...
                            <div className="tracking-[0.12px] font-avenirnext-medium text-white text-xxxl font-medium">{data.announcement}</div>
                        </div>
                        <div className="flex flex-row justify-start items-center w-full space-x-10 mt-14">
                            <div className="bg-[url('/img/combined-shape-2-1x-png@1x.png')] bg-center bg-cover h-[25px] w-[25px] ml-px "></div>
                            <div className="tracking-[0.12px] font-avenirnext-medium text-white text-xxxl font-medium">{data.taxCalculator}</div>
                        </div>
                        <div className="flex flex-row justify-start items-center w-full space-x-10 mt-14">
                            ...
                            <div className="tracking-[0.12px] font-avenirnext-medium text-white text-xxxl font-medium">{data.staking}</div>
                        </div>
                        <div className="flex flex-row justify-start items-center w-full space-x-10 mt-auto mb-80">
                            ...
                            <div className="tracking-[0.12px] font-avenirnext-medium text-white text-xxxl font-medium">{data.disconnect}</div>
                        </div>
                    </div>
                </div>
            </div>
