            ...
            <div className="flex flex-wrap -mx-4">
              <div className="mb-8 lg:mb-0 w-full lg:w-1/3 px-4">
                <div className="py-12 lg:py-20 rounded bg-black bg-opacity-50  shadow-md text-center">
                  ...
                  <div className="flex justify-center items-center"><a target="_blank" href="mailto:team@defire.org"><span className=" inline-block w-24 h-24">
              ...
              <div className="mb-8 lg:mb-0 w-full lg:w-1/3 px-4">
                <div className="py-12 lg:py-20 rounded bg-black  bg-opacity-50 shadow-md text-center">
                  ...
                  <div className="flex justify-center items-center"><a target="_blank" href="https://discord.gg/defire"><img className="w-24 h-24" src="svg/discord.svg" alt="" /></a></div>
                </div>
              </div>
              <div className="w-full lg:w-1/3 px-4 flex items-stretch">
                <div className="py-12 lg:py-20 w-full rounded bg-black bg-opacity-50 shadow-md text-center">
                  ...
                  <div className="flex justify-center items-center"><a target="_blank" href="https://medium.com/@defire.org"><span className="mr-8 inline-block w-24 h-24">
                    ...
                    </svg></span></a>                  <a target="_blank" href="https://twitter.com/DeFIRE_ORG"><img className="w-24 h-24" src="svg/twitter.svg" alt="" /></a></div>
                </div>
              </div>
            </div>
          </div>
