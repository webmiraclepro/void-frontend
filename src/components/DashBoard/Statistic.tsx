    ...
    <div className="flex flex-row items-end justify-center bg-center bg-cover mt-7 min-h-[413px] w-full py-5 px-6 bg-[url('/img/rectangle-4@1x.png')]">
      <div className="flex flex-col w-full">
        ...
        <div className="flex items-center mt-2 w-full">
          <div className="bg-white rounded-lg shadow-[10px_24px_54px_ #0000000f] flex h-[310px] xl:w-[440px] 2xl:w-[640px] font-poppins font-normal text-x04051a text-fsm">
            ...
            <div className="flex flex-1 items-end mb-5 2xl:ml-8 xl:ml-2.5 mr-9 2xl:min-w-[calc(100.00% -122px)]">
